...
ALTER TABLE "feed_follows" ADD COLUMN "updated_at" timestamp DEFAULT now() NOT NULL;--> statement-breakpoint
...
ALTER TABLE "feed_follows" DROP COLUMN "update_at";--> statement-breakpoint
ALTER TABLE "feeds" DROP COLUMN "update_at";